""" This module scrapes SVG logos from Wikidata.
"""
...
def logo_scraper(nb_svgs=100, target_folder='data/raw/scraped_logos'):
...
if __name__ == '__main__':
    df = logo_scraper(nb_svgs=10, target_folder='../../data/raw/scraped_logos')
