...
def save_animated_svg(doc, filename):
    """ Save animated SVGs to folder logos_animated_random.
    ...
    """
    Path("../../data/interim/logos_animated_random").mkdir(parents=True, exist_ok=True)

    with open('../../data/interim/logos_animated_random/' + filename + '.svg', 'wb') as f:
