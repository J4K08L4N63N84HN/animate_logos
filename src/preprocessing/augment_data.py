...
def augment_data(folder='data/svgs',
                 nb_augmentations=2,
                 df_dir='data/model_path_animation_decision/model_1_train.csv',
    ...
    if save:
        ...
        df_full.to_csv(f'data/model_path_animation_decision/model_1_train_nb_augmentations_{nb_augmentations}_{date_time}.csv', index=False)
